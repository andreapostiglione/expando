...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "doctor.grant_target": {"it": "App da abilitare", "en": "App to enable"},
    ...
    "wizard.welcome": {
        "it": "Expando ha bisogno di due permessi macOS per riconoscere le abbreviazioni e sostituirle con i tuoi snippet.",
        "en": "Expando needs two macOS permissions to recognize abbreviations and replace them with your snippets.",
    },
    "wizard.accessibility.title": {"it": "Accessibilità", "en": "Accessibility"},
    "wizard.accessibility.body": {
        "it": "Abilita Expando per permettere la sostituzione del testo nelle app.",
        "en": "Enable Expando so it can replace text in apps.",
    },
    "wizard.input.title": {"it": "Monitoraggio input", "en": "Input Monitoring"},
    "wizard.input.body": {
        "it": "Abilita Expando per riconoscere le abbreviazioni mentre digiti.",
        "en": "Enable Expando so it can recognize abbreviations while you type.",
    },
    "wizard.done": {
        "it": "Configurazione completata. Puoi creare il primo snippet dal menu Expando.",
        "en": "Setup complete. You can create your first snippet from the Expando menu.",
    },
    ...
    "menubar.health": {"it": "Controlla stato", "en": "Check status"},
    ...
    "menubar.hub_updates": {
        "it": "Aggiorna raccolte snippet",
        "en": "Update snippet collections",
    },
    "menubar.hub_updates_count": {
        "it": "Aggiorna raccolte ({count})",
