...
PYTHONPATH="$SITE_PACKAGES" python3 -c "from expando.paths import package_root; root = package_root(); assert (root / 'default_config' / 'config' / 'default.yml').is_file(), root; import expando; print(expando.__version__)"
